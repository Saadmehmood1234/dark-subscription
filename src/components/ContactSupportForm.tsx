  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-4 right-4 cursor-pointer text-gray-300 hover:text-red-400 transition"
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="relative">
          <label htmlFor="subject" className="block max-sm:text-sm text-gray-300 mb-2">
            Subject *
          </label>
          <div className="relative">
            <select
              ...
              className="w-full max-sm:text-sm pl-4 pr-10 py-2 bg-[#0C1B44]/70 rounded-lg border border-[#A92EDF]/30 focus:border-[#C27AFF] focus:outline-none backdrop-blur-sm appearance-none"
            >
          ...
          {errors.subject && (
            <p className="text-red-400 max-sm:text-sm text-sm mt-1 flex items-center gap-1">
        ...
        <div className="relative">
          <label htmlFor="message" className="block max-sm:text-sm text-gray-300 mb-2">
            Message *
          </label>
          <div className="relative">
            <MessageSquare
        ...
        <div className="flex flex-wrap  justify-center gap-6 text-gray-400 mt-4 text-sm">
