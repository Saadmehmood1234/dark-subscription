      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="relative backdrop-blur-sm bg-[#0C1B44]/70 border border-[#A92EDF]/30 rounded-3xl overflow-hidden shadow-2xl">
            <div className="h-1 bg-linear-to-r from-[#A92EDF] via-[#3B82F6] to-[#031877] w-full" />

            <UserProfile user={session.user} />

            <div className="h-px bg-linear-to-r from-transparent via-[#A92EDF] to-transparent mx-8 my-6" />
